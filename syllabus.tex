...
\small
	...
	\begin{tabular}{lp{5cm}p{6cm}p{4cm}}
		...
		2 & Modelleerimine. Kasud, kahjud. Numbrilised meetodid. UMLi ja ORMi põhitõed. Staatiline ja dünaamiline vaade. & Modelleerime: ERP, veebipood, kohtvõrk, EMTA, Avaandmed. Loengu pidamise äriprotsess & \cite{OPM}; \cite{umldistilled}\\
		3 & Arhitektuur, väärtus ja äri& & \\
		4 & Äriprotsess ja selle modelleerimine & & \\
